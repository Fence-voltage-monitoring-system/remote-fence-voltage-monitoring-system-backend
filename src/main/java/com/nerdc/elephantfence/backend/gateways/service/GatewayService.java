...
public class GatewayService {
    ...
    @Transactional(readOnly = true)
    public GatewayResponseDTO getGatewayById(String idStr) {
        Long id = parseGatewayId(idStr);
        Gateway gateway = gatewayRepository.findById(id)
                .orElseThrow(() -> new IllegalArgumentException("Gateway not found with ID: " + idStr));
    ...
    private void validateRBAC(UserPrincipal principal, Set<Fence> targetFences) {
        ...
        if (targetFences != null && !targetFences.isEmpty()) {
